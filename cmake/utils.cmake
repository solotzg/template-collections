...
if(USE_CCACHE
  ...
  if(ENABLE_PCH)
    execute_process(
      ...
      OUTPUT_VARIABLE _CCACHE_SLOPPINESS
    ...
    if(_CCACHE_SLOPPINESS_RES STREQUAL "-1")
      message(
        WARNING
          "`Precompiled header` won't be cached by ccache, sloppiness = `${CCACHE_SLOPPINESS}`,please execute `ccache -o sloppiness=pch_defines,time_macros`"
      )
      set(ENABLE_PCH
          FALSE
          CACHE BOOL "" FORCE)
...
function(print_flags)
  ...
  set(FULL_EXE_LINKER_FLAGS
      "${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_EXE_LINKER_FLAGS_${CMAKE_BUILD_TYPE_UC}}"
  )
...
function(check_and_target_link condition target)
  if(${condition})
    message(STATUS "Target ${target} link libraries ${ARGN}")
